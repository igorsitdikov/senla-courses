...
import com.senla.bulletinboard.BulletinBoardApplication;
...
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT, classes = BulletinBoardApplication.class)
